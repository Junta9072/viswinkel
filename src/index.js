...
function expandDate() {
  document
    .querySelector('.header__uren__expand')
    .classList.toggle('expand--rotate180');
  document
    .querySelector('.expand__dropdown')
    .classList.toggle('expand__dropdown--active');
}

function expandContact() {
  document
    .querySelector('.header__contact__expand')
    .classList.toggle('expand--rotate180');
  document
    .querySelector('.expand__dropdown__contact')
    .classList.toggle('expand__dropdown--active');
}
...
async function success() {
  const apiKey =
    'pk.eyJ1IjoianVudGEiLCJhIjoiY2t6eTVjb3FvMDBmdDJwbWx3N2h6ZWRtMCJ9.AxccJaxPcaqaot9HiUlnEg';
